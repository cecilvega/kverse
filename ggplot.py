...
COLORS = [
    '#140a9a',  # 1. Azul Gloria
    '#ffc82f',  # 2. Amarillo Natural
    '#f37021',  # 3. Naranja Joy
    '#00a7e1',  # 4. Azul Claro
    '#2bb673',  # 5. Verde Montabert
    '#ff0000',  # 6. Rojo Forestal
    '#7030a0',  # 7. Morado
    '#e7218d',  # 8. Rosa
    '#cbf266'   # 9. Verde (Light Green)
]

KOMATSU_COLORS = {
    "primary_blue": COLORS[0],      # Azul Gloria
    "primary_yellow": COLORS[1],    # Amarillo Natural
    "light_blue": COLORS[3],        # Azul Claro
    "gray": "#E5E5E5",
    "text_primary": "#333333",
...
# Extended color palette for multiple series using the new colors
...
def theme_komatsu(figure_size=(7, 5)):
    ...
    return p9.theme_minimal() + p9.theme(
        ...
        text=p9.element_text(family="Helvetica", color=KOMATSU_COLORS["text_primary"], size=9),
