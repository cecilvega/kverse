...
TIDY_NAMES = {
    ...
    "equipment_hours": "SMR",
    "component_hours": "Horas Comp.",
    "component_usage": "%Uso Comp.",
    # "last_changeout_date",
    # "last_changeout_smr",
    ...
    # RESO COLUMNAS
    "main_component": "Componente RESO",
    "subcomponent_tag": "Tag Subcomponente",
    "position_tag": "Tag Posición",
    "component_serial": "Serie Componente",
    "service_order": "OS140",
    "reception_date": "Fecha Recepción RESO",
    "first_quotation_date": "Fecha Primer PPTO",
    "latest_quotation_date": "Fecha Último PPTO",
    "approval_date": "Fecha Aprobación",
    "load_preliminary_report_date": "Fecha Informe Inicial",
    "load_final_report_date": "Fecha Informe Final",
    "reso_closing_date": "Fecha Cierre RESO",
    "warehouse_reception_date": "Fecha Recepción Bodega",
    "repair_cost": "Costo Reparación",
    "evaluacion": "Días Evaluación",
    "ajuste_presupuesto": "Días Ajuste Presupuesto",
    "espera_aprobacion": "Días Espera Aprobación",
    "reparacion": "Días Reparación",
    "despacho": "Días Despacho",
}
