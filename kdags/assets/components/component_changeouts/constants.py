COMPATIBILITY_MAPPING = {
    ...
    ("blower_parilla", "blower_parilla"): ("blower_parrilla", "blower_parrilla"),
    ("blower_parrilla", "blower_parilla"): ("blower_parrilla", "blower_parrilla"),
    ...
    ("mdp", "motor"): ("modulo_potencia", "motor"),
    ...
    ("freno_de_estacionamiento", "freno_de_estacionamiento"): (
        "motor_traccion",
        "freno_estacionamiento",
    ),
